...
.controller('ControlPerangkatCtrl',['PerangkatsLiteFac','PerangkatsFac','StoresCombFac','ToastService','$ionicPopup','$cordovaDialogs','StorageService','UtilService','$ionicModal','$ionicLoading','$scope','$filter','$timeout', 
function(PerangkatsLiteFac,PerangkatsFac,StoresCombFac,ToastService,$ionicPopup,$cordovaDialogs,StorageService,UtilService,$ionicModal,$ionicLoading,$scope,$filter,$timeout) 
{
...
/** AWAL DARI PEMBAYARAN PERANGKAT FUNCTION **/
    $scope.modalbayariuranopen   = function(perangkat,indexperangkat)
    {
        ...
        .then(function(modal) 
        {
            ...
            $scope.iuranyangharusdibayar.PAKET_GROUP            = perangkat.PAKET_GROUP;
            $scope.iuranyangharusdibayar.PAKET_ID               = perangkat.PAKET_ID;
            $scope.iuranyangharusdibayar.PAKET_NM               = perangkat.PAKET_NM;
            $scope.iuranyangharusdibayar.PAKET_DURATION         = perangkat.PAKET_DURATION;
            $scope.iuranyangharusdibayar.PAKET_DURATION_BONUS   = perangkat.PAKET_DURATION_BONUS;
            $scope.iuranyangharusdibayar.HARGA_BULAN            = perangkat.HARGA_BULAN;
            $scope.iuranyangharusdibayar.HARGA_HARI             = perangkat.HARGA_HARI;
            $scope.iuranyangharusdibayar.HARGA_PAKET            = perangkat.HARGA_PAKET;
            $scope.iuranyangharusdibayar.HARGA_PAKET_HARI       = perangkat.HARGA_PAKET_HARI;
            $scope.iuranyangharusdibayar.PAKET_STT              = perangkat.PAKET_STT;
            $scope.iuranyangharusdibayar.PAKET_STT_NM           = perangkat.PAKET_STT_NM;
...
/** AKHIR DARI PEMBAYARAN PERANGKAT FUNCTION **/
...
/** AWAL DARI PERANGKAT CRUD FUNCTION **/
    ...
    $scope.modalupdateperangkatopen   = function(perangkat,indexperangkat)
    {
        ...
        .then(function(modal) 
        {
            ...
            $scope.updateperangkat.PERANGKAT_UUID_BARU  = undefined;
            $scope.dataperangkatsblmdiupdate            = angular.copy($scope.updateperangkat)
            $scope.indexperangkat                       = angular.copy(indexperangkat);
    ...
    {        
        ...
        {
            $scope.updateperangkat.PERANGKAT_UUID = $scope.updateperangkat.PERANGKAT_UUID_BARU;
            PerangkatsFac.UpdatePerangkats($scope.updateperangkat)
            .then(function(response)
            {
    ...
    $scope.pilihswitchperangkat = function()
    {
        $scope.choiceswitchperangkat       = {PERANGKAT_UUID:undefined};
        $ionicPopup.confirm({
          templateUrl: 'templates/control/perangkat/popuplistperangkat.html',
          ...
          },
          {
            ...
            onTap: function (e) 
            {
                $scope.updateperangkat.PERANGKAT_UUID_BARU = $scope.choiceswitchperangkat.PERANGKAT_UUID;
            }
          }]
        });
    }
