...
function(OfflineLiteFac,UtilService,$rootScope,$q,$cordovaSQLite)
{
    var GetMerchants = function (parameters)
    {
        ...
        var query       = 'SELECT * FROM Tbl_Merchants WHERE STORE_ID = ? GROUP BY MERCHANT_ID';
    ...
    var UpdateMerchants = function (datatosave,fromwhere)
    {
        var deferred        = $q.defer();
    ...
    var CreateMerchantBanks = function (datatosave)
    {
        ...
        var isitable        = [TGL_SAVE,BANK_ID,BANK_NM,DCRP_DETIL,STATUS]
        var query           = 'INSERT INTO Tbl_MerchantBanks(TGL_SAVE,BANK_ID,BANK_NM,DCRP_DETIL,STATUS) VALUES (?,?,?,?,?)';
        $cordovaSQLite.execute($rootScope.db,query,isitable)
        .then(function(result) 
        {
            deferred.resolve(result);
    ...
    var UpdateMerchantBanks = function (datatosave)
    {
        ...
        var isitable        = [TGL_SAVE,BANK_NM,DCRP_DETIL,STATUS,BANK_ID]
        var query           = 'UPDATE Tbl_MerchantBanks SET TGL_SAVE=?,BANK_NM=?,DCRP_DETIL=?,STATUS=? WHERE BANK_ID=?';
        $cordovaSQLite.execute($rootScope.db,query,isitable)
        .then(function(result) 
        {
            deferred.resolve(result);
