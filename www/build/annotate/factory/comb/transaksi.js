...
.factory('TransaksiCombFac',['$rootScope', '$http', '$q', '$filter', '$cordovaSQLite', 'UtilService', 'TransaksisFac', 'TransaksisLiteFac', 'ShopCartLiteFac', function($rootScope,$http,$q,$filter,$cordovaSQLite,UtilService,TransaksisFac,TransaksisLiteFac,ShopCartLiteFac)
{
