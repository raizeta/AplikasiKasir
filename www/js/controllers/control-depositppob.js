...
/** AWAL DARI STORES CRUD FUNCTION **/
	...
	$scope.modalnewstoresubmit = function() 
    {
        ...
        .then(function()
        {
            ...
            {
                $cordovaToast.show('Toko Baru Berhasil Disimpan!', 'long', 'bottom');
            },
            function(error)
            {
                console.log(error);
        ...
        function(error)
        {
            $cordovaToast.show('Toko Baru Gagal Disimpan!', 'long', 'bottom');
        });
    };
    ...
    $scope.modalupdatestoresubmit   = function()
    {
        ...
        if(!_.isEqual($scope.datadetail, $scope.updatestore))
        {
            ...
            .then(function(resupdatestores)
            {
                ...
                $cordovaToast.show('Data Toko Berhasil Diubah', 'long', 'bottom');
            },
            function(error)
            {
                $cordovaToast.show('Data Toko Gagal Diubah', 'long', 'bottom');
            });  
        }
...
/** AWAL DARI PRODUCT CRUD FUNCTION **/
    ...
    {        
        ...
        .then(function(responsesetbarang)
        {
            ...
            $cordovaToast.show('Produk Baru Berhasil Disimpan!', 'long', 'bottom');
        },
        function(errorsetbarang)
        {
            $cordovaToast.show('Produk Baru Gagal Disimpan!', 'long', 'bottom');
        });   
    };
    ...
    $scope.modalupdateproductsubmit = function() 
    {
        if(!_.isEqual($scope.updateproducts[$scope.indexproduct], $scope.updateitemproduct))
        {
            ...
            .then(function(resupdateproduct)
            {
                ...
                $cordovaToast.show('Data Produk Berhasil Diubah!', 'long', 'bottom');
            },
            function(error)
            {
                $cordovaToast.show('Data Produk Gagal Diubah!', 'long', 'bottom');
            }); 
        }
        else
        {
        ...
        else
        {
            ...
            .then(function(responsecreatestock)
            {
                ...
                .then(function(response)
                {
                    ...
                    $cordovaToast.show('Penambahan Stok Berhasil Disimpan!', 'long', 'bottom');
                },
                function(error)
                {
                    console.log(error);
            ...
            function(error)
            {
                $cordovaToast.show('Penambahan Stok Gagal Disimpan!', 'long', 'bottom');
            })
        }
    }
    ...
    $scope.tambahharga = function(newharga)
    {
        ...
        else
        {
            ...
            .then(function(responsecreateharga)
            {
                ...
                $cordovaToast.show('Penambahan Harga Berhasil Disimpan!', 'long', 'bottom');
            },
            function(error)
            {
                $cordovaToast.show('Penambahan Harga Gagal Disimpan!', 'long', 'bottom');
            })
        }
    ...
    $scope.tambahdiskon = function(newdiscount)
    {
        ...
        else
        {
            ...
            .then(function(responsecreateharga)
            {
                ...
                $cordovaToast.show('Penambahan Diskon Berhasil Disimpan!', 'long', 'bottom');
            },
            function(error)
            {
                $cordovaToast.show('Penambahan Diskon Gagal Disimpan!', 'long', 'bottom');
            })
        } 
    }
                                    ...
                                    .then(function()
                                    {
                                        ...
                                        if(!$scope.productimages)
                                        {
                                            ...
                                            .then(function(responsecreategambar)
                                            {
                                                ...
                                                $cordovaToast.show('Gambar Produk Berhasil Diupload!', 'long', 'bottom');
                                            },
                                            function(error)
                                            {
                                                $cordovaToast.show('Gambar Produk Gagal Diupload!', 'long', 'bottom');     
                                            })
                                            .finally(function()
                                            {
                                                $ionicLoading.hide();     
...
/** AWAL DARI MERCHANTS CRUD FUNCTION **/
    ...
    $scope.modalnewmerchantsubmit = function() 
    {
        ...
        .then(function(ressavenewmerchant)
        {
            ...
            $cordovaToast.show('Penambahan Merchant Berhasil.', 'long', 'bottom');
        },
        function(error)
        {
            $cordovaToast.show('Penambahan Merchant Gagal.', 'long', 'bottom');
        });
    };
    ...
    $scope.modalupdatemerchantsubmit = function() 
    {
        if(!_.isEqual($scope.datamerchantsebelumdiupdate, $scope.updatemerchant))
        {
            ...
            {
                $scope.datamerchants[$scope.indexmerchant] = $scope.updatemerchant;
                $cordovaToast.show('Data Merchant Berhasil Diupdate!', 'long', 'bottom');
            },
            function(error)
            {
                $cordovaToast.show('Data Merchant Gagal Diupdate!', 'long', 'bottom');            
            });
        }
...
/** AWAL DARI CUSTOMERS CRUD FUNCTION **/
    ...
    $scope.modalnewcustomersubmit = function() 
    {
        ...
        .then(function(rescreatecustomer)
        {
            ...
            $cordovaToast.show('Pelanggan Baru Berhasil Disimpan!', 'long', 'bottom');
        },
        function(error)
        {
            $cordovaToast.show('Pelanggan Baru Gagal Disimpan!', 'long', 'bottom');
        });
    };
    ...
    {        
        if(!_.isEqual($scope.datacustomersblmdiupdate,$scope.updatecustomer))
        {
            ...
            .then(function(rescreatecustomer)
            {
                ...
                $cordovaToast.show('Data Pelanggan Berhasil Diubah!', 'long', 'bottom');
            },
            function(error)
            {
                $cordovaToast.show('Data Pelanggan Gagal Diubah!', 'long', 'bottom');
            });
        }   
    };
...
/** AWAL DARI USER-LOGINS CRUD FUNCTION **/
    ...
    $scope.modalnewuserloginsubmit = function() 
    {
        ...
        .then(function(ressetops)
        {
            ...
            $cordovaToast.show('Penambahan Operasional Berhasil Disimpan!', 'long', 'bottom');
        },
        function(error)
        {
            $cordovaToast.show('Penambahan Operasional Gagal Disimpan!', 'long', 'bottom');
        })
    ...
    $scope.modalupdateuserloginsubmit = function() 
    {
        ...
        .then(function(resupdateops)
        {
            ...
            $scope.newuserloginmodal.remove();
            $cordovaToast.show('Data Operasional Berhasil Diubah!', 'long', 'bottom');
        },
        function(error)
        {
            $cordovaToast.show('Data Operasional Gagal Diubah!', 'long', 'bottom');
        });
    };
