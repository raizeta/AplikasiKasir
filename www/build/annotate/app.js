...
.run(['$ionicPlatform', '$window', '$rootScope', '$cordovaStatusbar', '$cordovaSQLite', 'StorageService', '$location', 'auth', function($ionicPlatform,$window,$rootScope,$cordovaStatusbar,$cordovaSQLite,StorageService,$location,auth) 
{
    auth.hookEvents();
...
.config(['$sceDelegateProvider', '$ionicConfigProvider', '$ionicConfigProvider', 'authProvider', 'toastrConfig', function ($sceDelegateProvider,$ionicConfigProvider,$ionicConfigProvider,authProvider,toastrConfig) 
{
...
.controller('AppCtrl', 
['ConnectivityMonitor', 'TemplateService', 'MenuService', 'StorageService', 'SecuredFac', 'UtilService', '$ionicActionSheet', '$cordovaCamera', '$cordovaImagePicker', '$location', '$ionicLoading', '$timeout', '$ionicHistory', '$scope', function(ConnectivityMonitor,TemplateService,MenuService,StorageService,SecuredFac,UtilService,$ionicActionSheet,$cordovaCamera,$cordovaImagePicker,$location,$ionicLoading,$timeout,$ionicHistory,$scope) 
{
