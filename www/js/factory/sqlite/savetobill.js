...
function($rootScope,$q,$cordovaSQLite,UtilService,$filter)
{
    var SetSaveToBill = function (datatosave)
    {
        ...
        var NOMOR_MEJA          = datatosave.NOMOR_MEJA;
        var isitable            = [TGL_SAVE,ACCESS_GROUP,STORE_ID,ACCESS_ID,TRANS_ID,ALIAS_TRANS_ID,NOMOR_MEJA];
        var query               = 'INSERT INTO Tbl_SaveBill (TGL_SAVE,ACCESS_GROUP,STORE_ID,ACCESS_ID,TRANS_ID,ALIAS_TRANS_ID,NOMOR_MEJA) VALUES (?,?,?,?,?,?,?)';
