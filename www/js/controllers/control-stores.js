...
/** AWAL DARI CUSTOMERS CRUD FUNCTION **/
    $scope.modalnewcustomeropen   = function()
    {
        ...
        .then(function(modal) 
        {
            ...
            .then(function(responsenewcustomerid)
            {
                ...
                $scope.datacustomersblmdicreate = angular.copy($scope.newcustomer);
            },
            function(error)
            {
                console.log(error);
    ...
    {
        if(!_.isEqual($scope.datacustomersblmdicreate,$scope.newcustomer))
        {
            $cordovaDialogs.confirm('Data Tidak Akan Tersimpan. Apakah Kamu Yakin Untuk Keluar?', ['Yakin','Cancel'])
            .then(function(buttonIndex) 
            {
...
/** AWAL DARI KARYAWANS CRUD FUNCTION **/
    ...
    $scope.modalnewkaryawanopen   = function()
    {
        ...
        .then(function(modal) 
        {
            ...
            .then(function(newkaryawanid)
            {
                ...
                $scope.newkaryawanbefore            = angular.copy($scope.newkaryawan);
            });
    ...
    {
        if(!_.isEqual($scope.newkaryawanbefore,$scope.newkaryawan))
        {
            $cordovaDialogs.confirm('Data Tidak Akan Tersimpan. Apakah Kamu Yakin Untuk Keluar?', ['Yakin','Cancel'])
            .then(function(buttonIndex) 
            {
...
/** AWAL DARI USER-LOGINS CRUD FUNCTION **/
    ...
    $scope.modalnewuserloginsubmit = function() 
    {
        ...
        .then(function(responseformserver)
        {
            responseformserver.STORE_ID = $scope.datadetail.STORE_ID;
            UserOpsLiteFac.CreateUserOperationals(responseformserver);
        },
        function(error)
        {
    ...
    {
        if(!_.isEqual($scope.newuserlogin,$scope.newuserloginbefore))
        {
            $cordovaDialogs.confirm('Data Tidak Akan Tersimpan. Apakah Kamu Yakin Untuk Keluar?', ['Yakin','Cancel'])
            .then(function(buttonIndex) 
            {
    ...
    $scope.modalupdateuserloginopen   = function(detailops)
    {
        ...
        .then(function(modal) 
        {
            ...
            $scope.datauserloginsebelumdiupdate         = angular.copy(detailops);
    ...
    {
        if(!_.isEqual($scope.updateuserlogin,$scope.datauserloginsebelumdiupdate))
        {
            $cordovaDialogs.confirm('Data Tidak Akan Tersimpan. Apakah Kamu Yakin Untuk Keluar?', ['Yakin','Cancel'])
            .then(function(buttonIndex) 
            {
