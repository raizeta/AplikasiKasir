...
.factory('InitStoresFac',['PPOBCombFac','ProvinsisCombFac','KaryawansCombFac','MerchantsCombFac','CustomersCombFac','ProductsCombFac','TransaksiCombFac','OpenCloseBookCombFac','$rootScope','$timeout','$http','$q','$filter','$window','$cordovaSQLite','UtilService',
function(PPOBCombFac,ProvinsisCombFac,KaryawansCombFac,MerchantsCombFac,CustomersCombFac,ProductsCombFac,TransaksiCombFac,OpenCloseBookCombFac,$rootScope,$timeout,$http, $q, $filter, $window,$cordovaSQLite,UtilService)
{
    var InitStores = function()
    {
        ...
        //     $timeout(function() 
        //     {
        //         $rootScope.$broadcast('loading-stores','Gambar Produk');
        //         return ProductsCombFac.GetProductImages(parameters);
        //     }, timeoutfinish * count++);
