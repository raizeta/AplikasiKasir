...
.controller('SettingCtrl',['$ionicActionSheet','SecuredFac','UtilService','StorageService','TemplateCssService','$ionicModal','$cordovaDialogs','$cordovaToast','$rootScope','$window','$scope','$state','$location','$timeout','$ionicLoading','$ionicHistory', 
function($ionicActionSheet,SecuredFac,UtilService,StorageService,TemplateCssService,$ionicModal,$cordovaDialogs,$cordovaToast,$rootScope,$window,$scope,$state,$location,$timeout,$ionicLoading,$ionicHistory) 
{
...
{
    $scope.isdevice             = {'ready':false};

    document.addEventListener("deviceready", function () 
    {
        $scope.isdevice.ready   = true;
