...
.factory('StoresCombFac',['$rootScope', '$http', '$q', '$filter', '$cordovaSQLite', 'UtilService', 'StoresLiteFac', 'StoresFac', function($rootScope,$http,$q,$filter,$cordovaSQLite,UtilService,StoresLiteFac,StoresFac)
{
