 ...
 */
/* jshint -W117 */
argo.hermesTestPinpad = (function () {
    'use strict';

    var nymph = require('nymph'),
        pinPadInstance = argo.pinPadHelper.pinPadInstance,
        pinKey = argo.pinPadHelper.pinKey,
        onKeyPress = argo.pinPadHelper.onKeyPress,
        masterKey = argo.pinPadHelper.masterKey,
        macKey = argo.pinPadHelper.macKey;
