...
function($http,$q,StorageService,UtilService)
{
    var Login = function(datalogin)
    {
        ...
        {
            var resultuser              = {};
            resultuser.STORES_ACTIVE    = {'STORE_ID':'1217041005870002','STORE_NM':'ZETASHOP'};
            StorageService.set('advanced-profile',resultuser);

            var parameters          = {};
            parameters.ACCESS_GROUP = '1217041005870002';
            parameters.ACCESS_ID    = '1217041005870002';
            parameters.access_token = '1217041005870002';
            parameters.username     = '1217041005870002';
            parameters.UUID         = '1217041005870002';  
    ...
    var GetAllProfileUserOps = function(parameters)
    {
        var deferred            = $q.defer();
        var globalurl           = UtilService.ApiUrl();      
        var url                 = globalurl + "login/user-profiles";

        delete parameters['ACCESS_GROUP'];
        delete parameters['ACCESS_ID'];
    ...
    var GetOneProfileUserOps = function(parameters)
    {
        var deferred            = $q.defer();
        var globalurl           = UtilService.ApiUrl();      
        var url                 = globalurl + "login/user-profiles";
    ...
    var GetOneUserOps = function(parameters)
    {
        var deferred            = $q.defer();
        var globalurl           = UtilService.ApiUrl();      
        var url                 = globalurl + "login/user-operationals";
	...
	return{
            ...
            GetAllProfileUserOps:GetAllProfileUserOps,
            GetOneProfileUserOps:GetOneProfileUserOps,
            RegistrationLoginOps:RegistrationLoginOps,
            UpdateProfileOps:UpdateProfileOps,
            GetListUserOps:GetListUserOps,
            GetOneUserOps:GetOneUserOps,
