 ...
 * @param {type} param2
 */
nla.directive('ngLetterAvatar', ['defaultSettings','$http', function (defaultSettings,$http) 
{
        return {
            restrict: 'AE',
            replace: true,
                ...
                function _generateLetterAvatar() 
                {
                    ...
                    else
                    {
                       if (c.charCodeAt(0) < 65) 
                        ...
                        {
                            var colorIndex = Math.floor((c.charCodeAt(0) - 65) % params.alphabetcolors.length);
